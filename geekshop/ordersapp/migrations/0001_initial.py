# Generated by Django 3.2.9 on 2022-01-21 08:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'Формируется'), ('STP', 'Отправлен в обработку'), ('PD', 'Оплачено'), ('PRD', 'Обрабатывается'), ('RDY', 'Готов к выдаче'), ('CNC', 'Заказ отменен')], default='FM', max_length=3, verbose_name='Статус заказа')),
